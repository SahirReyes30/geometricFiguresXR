...
import examenAreaTriangulo from '../Modules/examenAreaTriangulo.png';
import examenAreaRectangulo from '../Modules/examenAreaRectangulo.png';
import examenAreaCilindro from '../Modules/examenAreaCilindro.png';
import examenVolumenCubo from '../Modules/examenVolumenCubo.png';
import pasaste2 from '../Modules/pasaste2.png';
import bienvenidaPreguntas from "../Modules/bienvenidoPreguntas.png"

import examenPlanaCubo from '../Modules/examenPlanaCubo.png';
import examenPlanaCilindro from '../Modules/examenPlanaCilindro.png';
import examenPlanaPiramide from '../Modules/examenPlanaPiramide.png';
import examenPlanaCono from '../Modules/examenPlanaCono.png';
import pasaste3 from '../Modules/pasaste3.png';
...
export function WindowUIVariasImagenesV2(name,width,height,img,scene) {
...
export function WindowUIVariasImagenesV3(name,width,height,img,scene) {
...
/*
    ...
    //crea un array de imagenes iniciando con la que llega de parametro
    var imagenes = [img, examenPlanaCono, examenPlanaCilindro,examenPlanaCubo , examenPlanaPiramide, pasaste3, noPasaste];
    var indexImagen = 0;
...
/*
    ...
    windowRepuesta5.hoverCursor = "pointer";
    var respuestasCorrectas = 0;
    var pasoElExamen = false;
    var barraExamen2 ,panelExamen2 ;
    //cambiar imagen al darle click al boton de la derecha
    windowRepuesta5.onPointerUpObservable.add(function() {
        if (indexImagen == 0) {
            console.log("bienvenida");
